    ...
    <div className="flex justify-start flex-col items-start w-full px-2 sm:px-6 mb-10">
      ...
      <div className="flex justify-start items-center w-full text-lg sm:text-lg ">
        ...
        <input
          placeholder="Name"
          type="text"
          className="border-b w-32 sm:w-40 py-1 px-2 mr-10 focus:border-pink-300 outline-none bg-transparent"
      ...
      <input
        ...
        type="text"
        className="border-b pt-4 w-28 sm:w-40 py-1 px-2 mr-10 focus:border-pink-300 outline-none bg-transparent mb-6"
